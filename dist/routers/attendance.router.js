...
const attendanceScheduler_service_1 = __importStar(require("../services/attendance/attendanceScheduler.service"));
class AttendanceRouter {
    ...
    initializeRoutes() {
        ...
        this.router.get("/scheduler", attendanceScheduler_service_1.default);
